...
class Stack {
    ...
    int size;
   public:
    Stack() {   // what the work of the constructor to initiallize the data members
        // Implement the Constructor
        // basically when we first make , like here, Stack s --- then class will create it with head = NULL and size = 0
        head = NULL;
        size = 0;
    }
    ...
    void push(int element) {
        ...
        // put the ele in the 0th ele
        // no need to check whether the head is null or not it will be handelled
