...
// striver ----- https://www.youtube.com/watch?v=aZNaLrVebKQ&t=5s

int findMid(int arr[], int start, int end, int key){
...
BinaryTreeNode<int>*helper(int *preorder, int preStart, int preEnd, int *inorder, int inStart, int inEnd){
	...
	// find the rootElement index from inorder Array --- the starting element of preorder will always be a root node ---
